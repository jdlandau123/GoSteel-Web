...
import { IAddress, ICustomer, IItemTemplate, IShow } from '../interfaces';
...
export class NewOrderComponent implements OnInit {
  ...
  setPackage(packageIndex: number, panel: IPanel) {
    this.dialog.open(SelectItemDialogComponent).afterClosed().subscribe((selectedItem: IItemTemplate) => {
